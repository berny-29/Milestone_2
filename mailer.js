            ...
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                    ...
                    <div style="padding: 30px; background-color: #f9f9f9;">
                        ...
                        <p>Best regards,<br><br>University of Vienna</p>
                    </div>
                </div>`
        });

        console.log('\nEnrollment email sent successfully to:', to);
        return info;
    } catch (error) {
        console.error('\nError sending enrollment email:', error);
        throw error;
    }
}
...
async function sendStudentCredentials(to, studentName, tempPassword) {
    try {
        ...
        console.log('\nStudent credentials email sent successfully to:', to);
        return info;
    } catch (error) {
        console.error('\nError sending student credentials email:', error);
